	...
	<?php
		...
		if(config::get('change_pass'))
		{
			...
			<div class="form-group">
				<input type="password" class="form-control" name="txt_password" placeholder="Wachtwoord" required="" id="username" />
			</div>

			<div class="form-group">
				<input type="password" class="form-control" name="txt_password_confirm" placeholder=" bevestig wachtwoord
" required="" id="password" />
			</div>

			<div class="form-group">
				<input type="submit" name="btn-changepass" value="Pas wijzigen
" />
			</div>
			<div class="form-group">
			<a href="<?php echo $redirect_login ?>"><b>annuleren</b></a>
			</div>
			<?php
		}
		else
